...
namespace alpr
{
  ...
  AlprFullDetails AlprImpl::recognizeFullDetails(cv::Mat img, std::vector<cv::Rect> regionsOfInterest)
  {
	...
	std::cout<<"===========End RETURN IMG AND WARPED REGION OF INTEREST and Country_aggregator===================================" <<std::endl;
	std::cout << "   " <<std::endl;
	std::cout << "   " <<std::endl;
	std::cout << "   " <<std::endl;
	
	std::cout<<"==============================SPLIT 4================================"<<std::endl;
	std::cout<<"==========HERE INPUT IMG AND WARPED REGIONS OF INTEREST and Country_aggregator============================================" <<std::endl;
  ...
  AlprFullDetails AlprImpl::analyzeSingleCountry(cv::Mat colorImg, cv::Mat grayImg, std::vector<cv::Rect> warpedRegionsOfInterest)
  {
	...
	std::cout << "==============Return PlateQueue==================" << std::endl;
	std::cout << "   " <<std::endl;
	std::cout << "   " <<std::endl;
	std::cout << "   " <<std::endl;
    ...
    {
	  std::cout << "--------Use Que to make pipeline data and to check if qualified---------" << std::endl;
	...
	std::cout << "==================Input pipeline_data===================" << std::endl;
      ...
      {
		std::cout << "--------------- Create plateResult------------------" << std::endl;
		...
		std::cout << "==========================split 7 Start===========================================" << std::endl;
	...
	std::cout << "===========================Split 7 END========================================" << std::endl;
	std::cout << "======================Return response===============================" << std::endl;
	std::cout << "   " <<std::endl;
	std::cout << "   " <<std::endl;
	std::cout << "   " <<std::endl;

	std::cout << "==========================split 8 Start===========================================" << std::endl;
  ...
  AlprResults AlprImpl::recognize( unsigned char* pixelData, int bytesPerPixel, int imgWidth, int imgHeight, std::vector<AlprRegionOfInterest> regionsOfInterest)
  {
	...
	try
    {
	  ...
	  std::vector<cv::Rect> convertedRegions = this->convertRects(regionsOfInterest);
	  splitreturn split2return(img, convertedRegions);
	  
	  
	  std::cout << "++++++++14 END return(img, convertRects(regionOfInterest))++++++++++++++++++++++" <<std::endl;
	  std::cout << "====================END Split 2======================================" <<std::endl;
	  std::cout << "===================Return img, regionsOfInterest=this->convertRects(regionsOfInterest)======================" <<std::endl;
	
	return this->recognize(split2return);
	//return split2return;
	//return this->recognize(img, convertedRegions);
    }
    catch (cv::Exception& e)
    {
      std::cerr << "Caught exception in OpenALPR recognize: " << e.msg << std::endl;
  ...
  AlprResults AlprImpl::recognize(splitreturn split2return)
  {
	
	std::cout << "====================== Split 3================================================" <<std::endl;
	std::cout << "================Call alpr_impl recognize(img, regionsOfInterest)=====================" <<std::endl;
      
	cv::Mat img = split2return.getImage();
	std::vector<cv::Rect> regionsOfInterest = split2return.getRegion();
